<template>
  <div class="signup-form"><!--sign up form-->
    ...
    <form action="#" method="post" @submit.prevent="register()">
      <input type="text" placeholder="Votre nom" name="name" v-model="register_data.name" />
      <input type="email" placeholder="Votre adresse email" name="email" v-model="register_data.email"/>
      <input type="password" placeholder="Votre mot de passe" name="password" v-model="register_data.password" />
      <input type="password" placeholder="Confirmation du mot de passe" name="password_confirmation" v-model="register_data.password_confirmation" />
